...
cprequire_test(["inline:com-chilipeppr-workspace-myhomecnc"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-myhomecnc", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-myhomecnc", // Make the id the same as the cpdefine id
        name: "Workspace / myHomeCNC", // The descriptive name of your widget.
        desc: `Chilipeppr Custom Workspace to myHomeCNC.`,
